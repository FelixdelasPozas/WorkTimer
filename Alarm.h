...
class Alarm : public QObject
{
  ...
  public:
    ...
    struct AlarmTime
    {
         ...
         * \param[in] d days number in [1,?]
         * \param[in] h hours number in [0,23]
         * \param[in] m minutes number in [0,59]
         * \param[in] s seconds number in [0,59]
         */
        explicit AlarmTime(int d, int h, int m, int s);

        /** \brief Returns the alarm time as text. 
         *
         */
        QString text() const;
    };
